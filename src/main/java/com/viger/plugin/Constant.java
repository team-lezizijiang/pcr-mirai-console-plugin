...
public class Constant {
    ...
    public static HashMap<Integer, ArrayList<String>> charData = new HashMap<>();
////            公主连接Re:dive的游戏数据
////
////
////            角色名称
...
//        1083: ["美咲(万圣节)", "ミサキ(ハロウィン)", "Misaki(Halloween)", "万圣美咲", "万圣大眼", "瓜眼", "?眼", "??", "???", "??"],
...
//        1127: ["铃(游侠)", "リン(レンジャー)", "Rin(Ranger)", "骑兵松鼠", "游侠松鼠", "游骑兵松鼠", "护林员松鼠", "护林松鼠", "游侠??", "武松","铃(游骑兵)"],
